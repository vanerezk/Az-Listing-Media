...
function Footer() {
  return (
    <>
          ...
          <Container>
            <Row
              ...
              <Col style={{fontSize: '14px', marginTop: '70px'}}>
                ...
                <hr style={{marginTop: '20px', marginBottom: '20px', width: '200px'}} />

                <span>
                  EMAIL: <br /> azlistingmedia@gmail.com
                </span>
              </Col>
              <Col
      ...
      <div
        className='bg-light  w-100  d-block d-lg-none '
        ...
        <Container>
          <Row
            ...
            <Col
              ...
              style={{marginTop: '35px', marginRight: '50px'}}>
